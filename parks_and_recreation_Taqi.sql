...
SELECT LENGTH('taqi') AS string_length;
...
SELECT UPPER('taqi') AS upper_result;
SELECT LOWER('TAQI') AS lower_result;
...
SELECT TRIM('              TAQI             ')  AS trimmed;
SELECT LTRIM('              TAQI             ') AS left_trimmed;
SELECT RTRIM('              TAQI             ') AS right_trimmed;
...
SELECT LOCATE('i', 'mohammed taqi k') AS position_of_i;
...
VALUES ('mohammed', 'taqi', 'wednesday');
...
VALUES (13, 'mohammed', 'taqi', 'data analyst', 1000000, NULL);
